    ...
    <div class="bg-gray-900/60 backdrop-blur border border-gray-800 rounded-2xl p-8">
        <form method="POST" action="{{ route('admin.vehicle-limits.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="number" name="max_amount" id="max_amount" value="{{ old('max_amount') }}" required step="0.01" min="1" placeholder="e.g., 500" class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all">
            ...
            <div>
                ...
                <input type="number" name="block_days_per_amount" id="block_days_per_amount" value="{{ old('block_days_per_amount', 1) }}" required step="0.01" min="0.01" class="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all">
